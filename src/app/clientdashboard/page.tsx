                  ...
                  <table className="table-auto">
                    ...
                    <tbody>
                      <tr className="border-t hover:border hover:border-blue-700 hover:shadow-md hover:bg-gray-50">
                        ...
                        <td className="text-[#1a9234]">
                          <div className="flex items-center gap-2">
                            <MdOutlineCheckCircle className="text-[#1a9234] text-lg" />
                            Active
                          </div>
                        </td>
                      ...
                      <tr className="border-t hover:border hover:border-blue-700 hover:shadow-md hover:bg-gray-50">
                        ...
                        <td>
                          <p className="flex items-center w-fit hover:bg-blue-700 hover:text-white justify-center gap-2 p-2 px-4 rounded bg-slate-200 text-blue-600">
                            View Applications
                          </p>
                        </td>
                      </tr>
